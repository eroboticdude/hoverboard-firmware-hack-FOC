...
//#define ELECTRIC_BRAKE_ENABLE           // [-] Flag to enable electric brake and replace the motor "freewheel" with a constant braking when the input torque request is 0. Only available and makes sense for TORQUE mode.
 ...
 #define ELECTRIC_BRAKE_THRES  180       // (0, 500) Threshold below at which the electric brake starts engaging.
...
#define ADC_PROTECT_TIMEOUT       300     // ADC Protection: number of wrong / missing input commands before safety state is taken
...
#define DEFAULT_FILTER              2400  // Default for FILTER 0.1f [-] lower value == softer filter [0, 65535] = [0.0 - 1.0].
...
#define DEFAULT_STEER_COEFFICIENT 6192    // Defualt for STEER_COEFFICIENT 0.5f [-] higher value == stronger. [0, 65535] = [-2.0 - 2.0]. In this case  8192 = 0.5 * 2^14. If you do not want any steering, set it to 0.
